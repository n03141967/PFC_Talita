...
\autor{Talita Atahalpa}
\autorR{Rodrigues Ferreira, Talita Atahalpa}

\titulo{\textless Percepção da feminina na computação\textgreater}
%\subtitulo{\textless  \textgreater}
...
%-------------------------------------------------------------- ORIENTADOR %
\orientadora{Elisângela Dias Silva}
\orientadoraR{Silva, Elisângela Dias}
